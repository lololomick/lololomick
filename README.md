...
Building web applications, APIs, and experimenting with systems programming. Running my own infrastructure and creating scalable solutions.

## About Me

* Full-stack developer specializing in Laravel and modern web technologies
* Self-hosting enthusiast - running my own production server infrastructure
* Focused on clean code, performance optimization, and scalable architectures
...
📫 Reach out if you want to build something cool together!
